...
pub const ACTIVE_CORE_CONSENSUS_VERSION_ENDPOINT: &str = "active_core_consensus_version";
pub const SUPPORTED_CORE_CONSENSUS_VERSION_ENDPOINT: &str = "supported_core_consensus_version";
pub const ACTIVATE_CORE_CONSENSUS_VERSION_ENDPOINT: &str = "activate_core_consensus_version";
...
pub const CURRENT_MODULE_FEE_CONSENSUS_JSON_ENDPOINT: &str = "current_module_fee_consensus_json";
pub const SET_MODULE_FEE_CONSENSUS_JSON_ENDPOINT: &str = "set_module_fee_consensus_json";

...
pub const FETCH_EPOCH_COUNT_ENDPOINT: &str = "fetch_epoch_count";
pub const FETCH_EPOCH_HISTORY_ENDPOINT: &str = "fetch_epoch_history";
...
pub const PROCESS_OUTCOME_ENDPOINT: &str = "process_outcome";
...
pub const UPGRADE_ENDPOINT: &str = "upgrade";

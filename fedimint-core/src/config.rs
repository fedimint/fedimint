...
pub struct FeeConsensus {
    pub fee_coin_spend_abs: fedimint_api::Amount,
    pub fee_peg_in_abs: fedimint_api::Amount,
    pub fee_coin_issuance_abs: fedimint_api::Amount,
    pub fee_peg_out_abs: fedimint_api::Amount,
    pub fee_contract_input: fedimint_api::Amount,
    pub fee_contract_output: fedimint_api::Amount,
}

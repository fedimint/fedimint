...
function devimint_recurringd_test() {
  fm-run-test "${FUNCNAME[0]}" ./scripts/tests/devimint-recurringd-test.sh
}
export -f devimint_recurringd_test

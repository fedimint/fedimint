...
use fedimint_api_client::api::{DynGlobalApi, EndpointRegistry, FederationApiExt, FederationError};
...
impl Opts {
    ...
    async fn make_endpoints(&self) -> Result<EndpointRegistry, anyhow::Error> {
        EndpointRegistry::build_from_client_defaults()

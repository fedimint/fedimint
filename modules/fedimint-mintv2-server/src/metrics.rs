...
pub(crate) static MINT_REDEEMED_ECASH_SATS: LazyLock<Histogram> = LazyLock::new(|| {
    register_histogram_with_registry!(
        histogram_opts!(
            ...
            "Value of redeemed e-cash notes in sats (deprecated - prefer mintv2_inout_sats)",
            AMOUNTS_BUCKETS_SATS.clone()
        ),
        REGISTRY
    )
...
pub(crate) static MINT_REDEEMED_ECASH_FEES_SATS: LazyLock<Histogram> = LazyLock::new(|| {
    register_histogram_with_registry!(
            histogram_opts!(
                ...
                "Value of e-cash fees during reissue in sats (deprecated - prefer mintv2_inout_fees_sats)",
                AMOUNTS_BUCKETS_SATS.clone()
            ),
            REGISTRY
        )
...
pub(crate) static MINT_ISSUED_ECASH_SATS: LazyLock<Histogram> = LazyLock::new(|| {
    register_histogram_with_registry!(
        histogram_opts!(
            ...
            "Value of issued e-cash notes in sats (deprecated - prefer mintv2_inout_sats)",
            AMOUNTS_BUCKETS_SATS.clone()
        ),
        REGISTRY
    )
...
pub(crate) static MINT_ISSUED_ECASH_FEES_SATS: LazyLock<Histogram> = LazyLock::new(|| {
    register_histogram_with_registry!(
        histogram_opts!(
            ...
            "Value of e-cash fees during issue in sats (deprecated - prefer mintv2_inout_fees_sats)",
            AMOUNTS_BUCKETS_SATS.clone()
        ),
        REGISTRY
    )

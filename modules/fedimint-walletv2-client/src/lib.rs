...
pub struct SendMeta {
    ...
    pub change_outpoints: Vec<OutPoint>,
...
impl WalletClientModule {
    ...
    /// Fetch the consensus feerate.
    pub async fn consensus_feerate(&self) -> FederationResult<Option<u64>> {
    ...
    pub async fn pending_transactions(&self) -> FederationResult<BTreeSet<bitcoin::Txid>> {
        self.module_api.pending_transactions().await
    }
    ...
    pub async fn send(
        ...
        let client_output = ClientOutput::<WalletOutput> {
            ...
            amount: Amount::from_sats((amount + send_fee.value).to_sat()),
        };
    ...
    pub async fn receive(
        ...
        let client_input = ClientInput::<WalletInput> {
            ...
            amount: Amount::from_sats((unspent_deposit.value - receive_fee.value).to_sat()),
        };

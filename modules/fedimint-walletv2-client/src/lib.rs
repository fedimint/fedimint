...
use fedimint_walletv2_common::{
    descriptor, DestinationScript, PendingInfo, ReceiveFee, SendFee, TransactionInfo,
...
impl WalletInfoApi {
    ...
    pub async fn pending(&self) -> FederationResult<PendingInfo> {
        self.0.pending_info().await
    }
    ...
    pub async fn log(&self, n_transactions: usize) -> FederationResult<Vec<TransactionInfo>> {
        self.0.transaction_log(n_transactions).await
    }
}

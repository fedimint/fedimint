...
impl IncomingContract {
    ...
    pub fn contract_key(&self) -> IncomingContractKey {
        IncomingContractKey(self.consensus_hash())
    }
...
impl OutgoingContract {
    pub fn contract_id(&self) -> sha256::Hash {
        self.consensus_hash()
    }

    pub fn contract_key(&self) -> OutgoingContractKey {
        OutgoingContractKey(self.contract_id())
    }

    pub fn forfeit_message(&self) -> Message {
        Message::from(self.contract_id())
    }

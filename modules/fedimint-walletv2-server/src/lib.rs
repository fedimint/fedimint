...
use fedimint_walletv2_common::{
    descriptor, is_valid_script, tweak_public_key, FederationWallet, TransactionInfo,
        ...
        vec![
            ...
            api_endpoint! {
                ...
                async |module: &Wallet, context, params: (u64, u64)| -> DepositRange {
                    Ok(module.get_deposits(&mut context.dbtx().into_nc(), params.0, params.1).await)
                }
            },
            api_endpoint! {

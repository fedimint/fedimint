...
mod api;
pub use fedimint_lnv2_common::gateway_registry::Lnv2RegistrySnapshotResult;
#[cfg(feature = "cli")]
mod cli;
pub mod db;
pub mod events;
...
impl LightningClientModule {
    ...
    pub async fn gateway_registry_snapshot(&self) -> anyhow::Result<Lnv2RegistrySnapshotResult> {
        self.module_api

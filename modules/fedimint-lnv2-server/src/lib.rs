...
use fedimint_lnv2_common::endpoint_constants::{
    ...
    GATEWAY_REGISTRY_EVIDENCE_ENDPOINT, GATEWAYS_ENDPOINT, OUTGOING_CONTRACT_EXPIRATION_ENDPOINT,
    REMOVE_GATEWAY_ENDPOINT,
};
use fedimint_lnv2_common::gateway_registry::Lnv2RegistryEvidenceV1;
    ...
    fn api_endpoints(&self) -> Vec<ApiEndpoint<Self>> {
        vec![
            ...
            public_api_endpoint! {
                ...
                ApiVersion::new(0, 1),
                async |_module: &Lightning, context, _params : () | -> Lnv2RegistryEvidenceV1 {
                    let db = context.db();
                    Ok(Lnv2RegistryEvidenceV1::new(Lightning::gateways(db).await))
                }
            },
        ]
    }

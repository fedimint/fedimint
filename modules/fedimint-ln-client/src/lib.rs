...
impl LightningClientModule {
    ...
    pub async fn gateway_registry_snapshot(
        &self,
    ) -> anyhow::Result<fedimint_ln_common::gateway_registry::Lnv1RegistrySnapshotResult> {
        self.module_api
            .gateway_registry_snapshot(self.cfg.threshold_pub_key)
            .await
            .map_err(Into::into)
    }

    /// Returns the federation whose gateway registry this module queries.

...
use fedimint_core::bitcoin_migration::{
    ...
    bitcoin32_to_bitcoin30_recoverable_signature, bitcoin32_to_bitcoin30_secp256k1_pubkey,
};
...
impl LightningClientModule {
    ...
    async fn create_bolt11_invoice_internal<M: Serialize + Send + Sync>(
        ...
        let (operation_id, invoice, output, preimage) = self.create_lightning_receive_output(
            ...
            rand::rngs::OsRng,
            expiry_time,
            bitcoin32_to_bitcoin30_secp256k1_pubkey(&src_node_id),
            short_channel_id,
            &route_hints,
...
pub async fn create_incoming_contract_output(
    ...
    let contract = IncomingContract {
        ...
        gateway_key: bitcoin30_to_bitcoin32_secp256k1_pubkey(&our_pub_key),
    };
    let contract_id = contract.contract_id();

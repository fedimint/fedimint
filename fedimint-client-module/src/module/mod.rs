...
use fedimint_core::module::{Amounts, CommonModuleInit, ModuleCommon, ModuleInit};
...
pub trait IClientModule: Debug {
    ...
    fn input_fee(&self, amount: &Amounts, input: &DynInput) -> Option<Amount>;

    fn output_fee(&self, amount: &Amounts, output: &DynOutput) -> Option<Amount>;

...
pub fn render(invite_code: &str, consensus_block_count: u32) -> Markup {
    html! {
            ...
            div class="card-body" {
                @if consensus_block_count == 0 {
                    div class="alert alert-warning" {
                        "The invite code will be available once the federation has confirmed the Bitcoin blockchain height."
                    }
                } @else {

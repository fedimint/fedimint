...
use crate::consensus::interconnect::FedimintInterconnet;
use crate::db::{
...
use fedimint_api::db::batch::{BatchTx, DbBatch};
    ...
    R: RngCore + CryptoRng,
{
    ...
    fn build_interconnect(&self) -> FedimintInterconnet<R> {
        FedimintInterconnet { fedimint: self }
    }
}

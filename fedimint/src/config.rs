...
impl GenerateConfig for ServerConfig {
    ...
    fn trusted_dealer_gen(
        ...
        let fee_consensus = FeeConsensus {
            fee_coin_spend_abs: fedimint_api::Amount::ZERO,
            fee_peg_in_abs: fedimint_api::Amount::ZERO,
            fee_coin_issuance_abs: fedimint_api::Amount::ZERO,
            fee_peg_out_abs: fedimint_api::Amount::ZERO,
            fee_contract_input: fedimint_api::Amount::ZERO,
            fee_contract_output: fedimint_api::Amount::ZERO,
        };

...
use crate::consensus::{ConsensusItem, ConsensusOutcome, ConsensusProposal, FedimintConsensus};
...
pub async fn run_fedimint(cfg: ServerConfig) {
    let server = FedimintServer::new(cfg.clone()).await;
...
impl FedimintServer {
    ...
    pub async fn new_with(
        ...
        let mint =
            fedimint_core::modules::mint::Mint::new(cfg.mint.clone(), threshold, database.clone());

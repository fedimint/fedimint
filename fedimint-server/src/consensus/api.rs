...
use crate::consensus::engine::{get_finished_session_count_static, ConsensusEngine};
...
impl ConsensusApi {
    ...
    pub async fn submit_transaction(
        ...
        let consensus_version_cache = ConsensusEngine::load_consensus_version_cache_static(
            &mut dbtx.to_ref_nc(),
            &self.modules,
            &self.module_inits,
            &self.cfg,

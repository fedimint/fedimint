...
use fedimint_core::endpoint_constants::{
    ADD_CONFIG_GEN_PEER_ENDPOINT, ADD_PEER_SETUP_CODE_ENDPOINT, ADD_PEER_SETUP_CODE_ENDPOINT,
    API_ANNOUNCEMENTS_ENDPOINT, API_ANNOUNCEMENTS_ENDPOINT, AUDIT_ENDPOINT, AUDIT_ENDPOINT,
    AUTH_ENDPOINT, AUTH_ENDPOINT, AWAIT_SESSION_OUTCOME_ENDPOINT, AWAIT_SESSION_OUTCOME_ENDPOINT,
    AWAIT_TRANSACTION_ENDPOINT, AWAIT_TRANSACTION_ENDPOINT, BACKUP_ENDPOINT, BACKUP_ENDPOINT,
    BACKUP_STATISTICS_ENDPOINT, BACKUP_STATISTICS_ENDPOINT, CHANGE_PASSWORD_ENDPOINT,
    CHANGE_PASSWORD_ENDPOINT, CONFIG_GEN_PEERS_ENDPOINT, FEDIMINTD_VERSION_ENDPOINT,
    FEDIMINTD_VERSION_ENDPOINT, GET_SETUP_CODE_ENDPOINT, GET_SETUP_CODE_ENDPOINT,
    GUARDIAN_CONFIG_BACKUP_ENDPOINT, GUARDIAN_CONFIG_BACKUP_ENDPOINT, GUARDIAN_METADATA_ENDPOINT,
    INVITE_CODE_ENDPOINT, INVITE_CODE_ENDPOINT, RECOVER_ENDPOINT, RECOVER_ENDPOINT,
    RESET_PEER_SETUP_CODES_ENDPOINT, RESET_PEER_SETUP_CODES_ENDPOINT,
    RESTART_FEDERATION_SETUP_ENDPOINT, RESTART_FEDERATION_SETUP_ENDPOINT, SESSION_COUNT_ENDPOINT,
    SESSION_COUNT_ENDPOINT, SESSION_STATUS_ENDPOINT, SESSION_STATUS_ENDPOINT,
    SESSION_STATUS_V2_ENDPOINT, SESSION_STATUS_V2_ENDPOINT, SET_LOCAL_PARAMS_ENDPOINT,
    SET_LOCAL_PARAMS_ENDPOINT, SET_PASSWORD_ENDPOINT, SET_PASSWORD_ENDPOINT, SETUP_STATUS_ENDPOINT,
    SETUP_STATUS_ENDPOINT, SHUTDOWN_ENDPOINT, SHUTDOWN_ENDPOINT, SIGN_API_ANNOUNCEMENT_ENDPOINT,
    SIGN_API_ANNOUNCEMENT_ENDPOINT, SIGN_GUARDIAN_METADATA_ENDPOINT, START_CONSENSUS_ENDPOINT,
    START_DKG_ENDPOINT, START_DKG_ENDPOINT, STATUS_ENDPOINT, STATUS_ENDPOINT,
    SUBMIT_API_ANNOUNCEMENT_ENDPOINT, SUBMIT_API_ANNOUNCEMENT_ENDPOINT,
    SUBMIT_GUARDIAN_METADATA_ENDPOINT, SUBMIT_TRANSACTION_ENDPOINT, SUBMIT_TRANSACTION_ENDPOINT,

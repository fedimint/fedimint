...
use crate::{
    DEPOSIT_ADDRESS_ROUTE, DynGatewayApi, SET_FEES_ROUTE, SPEND_ECASH_ROUTE, redirect_error,
    redirect_success,
};
                        ...
                        div class="tab-content mt-3" {
                            ...
                            div class="tab-pane fade"
                                     ...
                                     hx-swap="innerHTML"
                                {
                                    ...
                                    // Optional: include_invite checkbox
                                    div class="form-check mb-3" {
                                        input type="checkbox"
                                            class="form-check-input"
                                            id={(format!("spend-invite-{}", fed.federation_id))}
                                            name="include_invite"
                                            value="true";
                                        label class="form-check-label" for={(format!("spend-invite-{}", fed.federation_id))} {
                                            "Include federation invite"
                                        }
                                    }
